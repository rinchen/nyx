...
| **Micro SSM mixer** (8-dim recurrent state as additional base model + Byte-Pair Re-Pair word model) | json, mr | **complete** | 65/65 tests pass; round-trip verified on mixed fixture; SsmMixer added as base model (not mixer replacement); BytePairDict built incrementally via ByteAssembler |
